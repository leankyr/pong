...
--            player2.y = VIRTUAL_HEIGHT/2
    ...
    -- calculate distance between ball and paddle of player1
    dist = player1.y - ball.y + PADDLE_HEIGHT/2
    c = 1
    if dist < 0 then
      player1.dy = c*PADDLE_SPEED
    else
      player1.dy = -c*PADDLE_SPEED
    end
    
    -- calculate distance between ball and paddle of player2
    dist = player2.y - ball.y + PADDLE_HEIGHT/2
    if dist < 0 then
      player2.dy = c*PADDLE_SPEED
    else
      player2.dy = -c*PADDLE_SPEED
    end
